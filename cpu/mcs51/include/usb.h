...
//#define DEFINE_STRING_DESCRIPTOR(name,char_count,...) static uint16 CODE name[] = { (2*(char_count+1)) | (3u<<8), __VA_ARGS__ };
...
extern uint8 XDATA usbDeviceState;
 ...
 *
 * This function must be defined by higher-level code.
 * See usb_cdc_0x02acm.c for an example. */
