 ...
 *                      @ref od_flags_bytes
 */
void od(const void *data, uint32_t data_len, uint8_t width, uint16_t flags);
 ...
 *                      @ref OD_WIDTH_DEFAULT is assumed as a default value.
 */
void od_hex_dump(const void *data, uint32_t data_len, uint8_t width);
/*static inline void od_hex_dump(const void *data, uint32_t data_len, uint8_t width)
{
